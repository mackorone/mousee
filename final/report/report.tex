...
computer vision and image processing, and numerical computation, respectively.

\subsection{Output images}
\label{sub:output_images}

\subsection{Runtime Analysis}
\label{sub:runtime_analysis}
...
Our first attempt at a solution to this problem consisted of 
